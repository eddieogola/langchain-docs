...
3. Log a trace.
   ...
   public class OtelTracingExample {
       public static void main(String[] args) {
           // Setup OpenTelemetry configuration for LangSmith
           ...
           // Get tracer
           Tracer tracer = GlobalOpenTelemetry.get().getTracer("my-java-app");

           // Option 1: Use WrappedOpenAIClient for automatic tracing
           WrappedOpenAIClient wrappedClient = WrappedOpenAIClient.fromEnv();

           Span span = tracer.spanBuilder("call_open_ai")
               .setAttribute("langsmith.span.kind", "LLM")
               .setAttribute("langsmith.metadata.user_id", "user_123")
               .setAttribute("gen_ai.system", "OpenAI")
               .setAttribute("gen_ai.request.model", "gpt-4o-mini")
               .setAttribute("llm.request.type", "chat")
               .startSpan();
           ...
           try (Scope scope = span.makeCurrent()) {
               ChatCompletionCreateParams params = ChatCompletionCreateParams.builder()
                   ...
                   .addUserMessage("Write a haiku about recursion in programming.")
                   .build();

               ChatCompletion completion = wrappedClient.chat().completions().create(params);
