...
The `extras` parameter on LangChain tools supports Anthropic-specific fields that enhance tool functionality.

### Input examples

For complex tools, you can provide usage examples to help Claude understand how to use them correctly:
